...
class Game {
  ...
  def createPlayer1Deck(): List[ICard] = {
  ...
  def createPlayer2Deck(): List[ICard] = {
  ...
  def player1PlayCard(): Unit = {
    ...
    println(s"Jugador 1 juega la carta: ${player1Card.name}")
  }
  ...
  def player2PlayCard(): Unit = {
    ...
    // Here you can write the game logic, possibly in the following implementations
    println(s"Jugador 2 juega la carta: ${player2Card.name}")
  }
}