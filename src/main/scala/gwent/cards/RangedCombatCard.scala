...
/**
 * A class representing a ranged combat card in the Gwent game.
 *
...
class RangedCombatCard(
  ...
  /**
   * Checks if the provided object can be equal to this ranged combat card.
   *
   * @param other The object to compare.
   * @return True if the object can be equal to this ranged combat card, false otherwise.
   */
